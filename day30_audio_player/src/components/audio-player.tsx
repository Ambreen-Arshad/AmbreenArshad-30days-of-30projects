...
const AudioPlayer: React.FC<AudioPlayerProps> = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-pink-900 text-foreground">
      <div className="max-w-md w-full space-y-4 bg-pink-500">
        <div className="flex items-center justify-between bg-pink-400">
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center gap-4 p-8 bg-pink-200">
            <Image
              src="/music.svg"
              alt="Album Cover"
              width={100}
