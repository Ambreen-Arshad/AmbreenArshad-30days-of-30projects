...
export default function GitHubProfileViewer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-pink-800 py-8">
      <Card className="w-full max-w-3xl p-6 space-y-4 shadow-lg rounded-lg bg-pink-300">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-600">
            ...
            repositories, search like: <span className = "text-red-700 font-extrabold">Ambreen-Arshad</span>
          </CardDescription>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="mb-8 px-6">
          <div className="flex items-center gap-4 ">
            <Input
              ...
              className="flex-1 border rounded-md p-2 bg-slate-300"
            />
            <Button
              type="submit"
              disabled={loading}
            ...
            <div className="grid gap-6">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6">
                {userRepos.map((repo) => (
                  <Card
                    key={repo.id}
                    className="shadow-md rounded-lg bg-slate-400 border"
                  >
                    <CardHeader>
                      <div className="flex items-center gap-2">
