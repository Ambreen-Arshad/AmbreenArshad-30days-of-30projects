...
export default function NotesApp() {
  ...
  return (
    <div className="flex flex-col h-screen bg-blue-200 text-foreground">
      <header className="bg-slate-700 p-4 shadow">
        <h1 className="text-2xl text-white font-bold">Note Taker</h1>
      </header>
      <main className="flex-1 overflow-auto p-4">
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full rounded-md border border-input bg-blue-300 p-2 text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
          />
          ...
          <textarea
            ...
            className="mt-2 w-full rounded-md border border-input bg-blue-300 p-2 text-foreground focus:outline-none focus:ring-1 focus:ring-primary"
            rows={4}
          />
          {/* Button to add or update note */}
          {editingNoteId === null ? (
            <Button onClick={handleAddNote} className="mt-2 bg-slate-700">
              Add Note
            </Button>
          ) : (
        ...
        <div className="grid gap-4">
          {notes.map((note) => (
            <Card key={note.id} className="p-4 bg-blue-300">
