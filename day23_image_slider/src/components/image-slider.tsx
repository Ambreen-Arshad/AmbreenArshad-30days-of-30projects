  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-pink-400">
      <div className="w-full max-w-2xl mx-auto">
        <h1 className="text-5xl font-extrabold text-center mb-4 ">𝕀𝕞𝕒𝕘𝕖 𝕊𝕝𝕚𝕕𝕖𝕣</h1>
        ...
        >
          <CarouselContent>
            {images.map((image, index) => (
              ...
              >
                ...
                />
                <div className="p-2 bg-purple-400/75 text-center">
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 ">
            <Button
              ...
              className="bg-pink-900/50 hover:bg-white/75 p-2 rounded-full shadow-md transition-colors"
            >
              {isPlaying ? (
