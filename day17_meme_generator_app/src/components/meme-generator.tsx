...
export default function MemeGenerator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background bg-yellow-400 text-stone-600 text-foreground">
      <div className="max-w-4xl w-full px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-8">
          {/* Header section */}
          <div className="text-center space-y-2">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
             😎 Meme Generator 😎<br /> 🤣<br />😛<br />🤐
            </h1>
            <p className="text-muted-foreground text-stone-900 underline">
            ...
            <>
              ...
              <div className="w-full overflow-x-scroll whitespace-nowrap py-2 ">
                {visibleMemes.map((meme) => (
                  <Card
                    key={meme.id}
                    className="inline-block bg-green-400 rounded-lg overflow-hidden cursor-pointer transition-transform hover:scale-105 mx-2"
              ...
              {visibleMemes.length < memes.length && (
                <Button
                  ...
                  className="mt-4 text-white bg-stone-700 hover:bg-stone-900"
          ...
          {selectedMeme && (
            <Card className="w-full max-w-md ">
              ...
              <CardContent>
                ...
                <Button className="w-full mt-4 text-white bg-stone-700 hover:bg-stone-900" onClick={handleDownload}>
                  Download Meme
                </Button>
              </CardContent>
            </Card>
