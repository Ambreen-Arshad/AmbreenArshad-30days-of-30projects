...
export default function SnakeGame() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-red-300 to-[#460707]">
      <div className="bg-[#1E1E1E] rounded-lg shadow-lg p-8 w-full max-w-md">
        <div className="flex items-center justify-between mb-6">
          <div className="text-3xl font-bold text-[rgb(255,52,79)]">Snake Game</div>
          <div className="flex gap-4">
            <Button
              variant="ghost"
              size="icon"
              className="text-[#66d334] hover:text-[#66d334ad] hover:bg-black"
              onClick={startGame}
            >
            ...
            <Button
              variant="ghost"
              size="icon"
              className="text-[#e1f530] hover:text-[#e1f530af]  hover:bg-black"
              onClick={pauseGame}
            >
            ...
            <Button
              variant="ghost"
              size="icon"
              className="text-blue-500 hover:text-blue-700  hover:bg-black"
              onClick={resetGame}
            >
        ...
        <div className="bg-[#faf5dc] rounded-lg p-4 grid grid-cols-10 gap-1">
        ...
        <div className="flex items-center justify-between mt-6 text-yellow-400">
          <div>Score: {score}</div>
