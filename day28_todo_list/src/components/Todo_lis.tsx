...
export default function TodoList() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-400 dark:bg-gray-900">
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        ...
        <div className="flex items-center mb-4">
          ...
          <Button
            onClick={addTask}
            className="bg-slate-700 hover:bg-slate-500 text-white font-medium py-2 px-4 rounded-md"
          >
            Add
          </Button>
        </div>
