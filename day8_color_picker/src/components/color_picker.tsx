...
export default function ColorPicker() {
  ...
  >
    <div className="flex flex-col items-center justify-center h-screen bg-black  dark:bg-gray-900">
      {/* Center the color picker card within the screen */}
      <Card className="w-full max-w-md mx-auto bg-gray-400 p-8 grid gap-8">
        ...
        <div className="grid gap-4">
          ...
          <div
            className="w-full h-48 rounded-lg border-4 border-gray-500 dark:border-red-900"
