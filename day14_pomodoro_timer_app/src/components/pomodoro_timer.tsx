...
export default function PomodoroTimer() {
  ...
  return ( 
    <div className="flex flex-col items-center justify-center min-h-screen bg-green-700 dark:bg-green-950">
      {/* Center the Pomodoro timer card within the screen */}
      <Card className="w-full max-w-md p-6 bg-green-500 dark:bg-white shadow-lg rounded-lg">
        <div className="flex flex-col text-green-950 items-center justify-center gap-6">
          <h1 className="text-4xl text-green-950 font-bold">Pomodoro Timer</h1>
          <p className="text-orange-600">A timer for the Pomodoro Technique.</p>
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-8xl text-orange-600 font-bold">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
             className ="text-black bg-yellow-300 hover:bg-green-700"
              variant="outline"
              size="icon"
            ...
            <Button className ="text-black bg-yellow-300 hover:bg-green-700" variant="outline" size="icon" onClick={handleStartPause}>
              {state.timerStatus === "running" ? (
                <PauseIcon className=" h-6 w-6" />
              ) : (
                <PlayIcon className="h-6 w-6 bg-yellow-300 hover:bg-green-700" />
              )}
            </Button>
            <Button className ="text-black bg-yellow-300 hover:bg-green-700"  variant="outline" size="icon" onClick={handleReset}>
          ...
          <div className="p-2">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button className="bg-yellow-300 hover:bg-green-700 text-green-950">What is Pomodoro Technique?</Button>
              </AlertDialogTrigger>
              <AlertDialogContent className=" max-w-2xl text-green-700 bg-yellow-200 p-4 md:p-6">
                <AlertDialogHeader>
                  <AlertDialogTitle>
...
`}{" "}
                    ...
                    <br />
                    <Button className="bg-yellow-600 hover:bg-green-700">
                      {" "}
                      <a
                ...
                <AlertDialogFooter>
                  <AlertDialogCancel className="bg-yellow-600 hover:bg-green-700">Cancel</AlertDialogCancel>
                  <AlertDialogAction className="bg-yellow-600 hover:bg-green-700">Continue</AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
          </div>
