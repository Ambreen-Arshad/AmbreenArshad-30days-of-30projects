...
export default function MovieSearch() {
  ...
  const handleSearch = async (): Promise<void> => {
    ...
    try {
      const response = await fetch(
        `https://www.omdbapi.com/?t=${searchTerm}&apikey=2b2467c4`
      );
      if (!response.ok) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-purple-950 p-4">
      <div className="w-full max-w-lg p-6 bg-purple-600 rounded-lg shadow-md">
        ...
        {movieDetails && (
          <div className="flex flex-col items-center">
            ...
            <div className="w-full text-center">
              ...
              <p className="text-blue-950 mb-4 italic">{movieDetails.Plot}</p>
              {/* Movie details section */}
              <div className="flex justify-center items-center text-blue-950 mb-2">
