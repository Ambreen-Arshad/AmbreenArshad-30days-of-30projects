...
export default function QuizApp() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-red-900 text-foreground">
      {state.showResults ? (
        ...
        <div className="bg-card bg-red-300   p-8 rounded-lg shadow-md w-full max-w-md">
