...
export default function Calculator() {
  ...
  >
    <div className="flex flex-col items-center justify-center h-screen dark:bg-gray-500"
   >
      {/* Center the calculator within the screen */}
      <Card className="w-full max-w-md p-6 bg-black dark:bg-gray-800 shadow-lg rounded-lg border-separate">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col text-center text-white space-y-2">
          ...
          <div className="grid grid-cols-4 gap-2">
            <Button
              variant="outline"
              className="text-2xl font-bold text-white bg-color bg-yellow-300 dark:text-gray-500"
              onClick={add}
            >
              +
            </Button>
          ...
          {/* Display the result */}
          <div className="flex flex-col text-center text-white bg-color  space-y-2">
          ...
          <Button variant="outline" className="w-full text-white bg-color bg-red-500" onClick={clear}>
            Clear
          </Button>
        </CardContent>
      </Card>
