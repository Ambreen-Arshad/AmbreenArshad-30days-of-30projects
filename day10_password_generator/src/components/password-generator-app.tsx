...
export default function GeneratePassword() {
  ...
  >
    <div className="flex flex-col items-center justify-center min-h-screen  dark:bg-blue-900">
      {/* Center the password generator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-blue-950 dark:bg-gray-200 shadow-lg rounded-lg">
        <div className="mx-auto max-w-md space-y-6">
          {/* Header with title and description */}
          <div className="space-y-2 text-center">
            <h1 className="text-3xl text-green-300 font-bold">Password Generator</h1>
          ...
          <div className="space-y-4">
            ...
            <Button type="button" className="w-full bg-green-300 text-blue-900 " onClick={generatePassword}>
              Generate Password
            </Button>
            ...
            <div className="space-y-2 text-white">
              ...
              <div className="flex items-center space-x-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button type="button" className="bg-green-300 text-blue-900" onClick={copyToClipboard}>
                  Copy to Clipboard
                </Button>
              </div>
            </div>
