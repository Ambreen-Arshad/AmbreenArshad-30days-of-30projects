...
export default function UnitConverter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-green-800 dark:bg-gray-900">
      {/* Center the unit converter card within the screen */}
      <div className="max-w-md w-full p-6 bg-card rounded-lg shadow-lg">
        <h1 className="text-2xl font-bold mb-1 text-center text-white color bg-gray-800">Unit Converter</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2 col-span-2 text-blue-950">
        ...
        <div className="mt-6 text-center">
          ...
          <div className="text-muted-foreground text-blue-950">
