...
export default function PomodoroTimer() {
  ...
  return ( 
    <div className="flex flex-col items-center justify-center min-h-screen bg-green-200 ">
      ...
      <Card className="w-full max-w-md p-6 bg-green-400 dark:bg-white shadow-lg rounded-lg">
        <div className="flex flex-col text-green-950 items-center justify-center gap-6">
          ...
          <p className="text-green-950">A timer for the Pomodoro Technique.</p>
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-8xl text-red-800 font-bold">
          ...
          <div className="p-2">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button className="bg-green-600 hover:bg-green-900 text-green-950">What is Pomodoro Technique?</Button>
              </AlertDialogTrigger>
...
`}{" "}
                    ...
                    <br />
                    <Button className="bg-yellow-200 hover:bg-green-700">
                      {" "}
                      <a
